...
import * as styles from './LinkedIn.module.css';
...
export function LinkedInTemplate({
  status,
  processing,
  handleSubmit,
  handleBackup,
  ...
  return (
    ...
    >
      ...
      <h1 className={styles.heading}>LinkedIn Account Attestation</h1>

      <Prompt
        when={preventNavigation}
        message="The LinkedIn attestation process has already started. Are you sure you want to leave?"
      />

      <Explainer>
        After you sign into your LinkedIn account and give SocialKYC permission,
        SocialKYC requests your LinkedIn information for the credential. You can
      ...
      {status === 'none' && (
        <DetailedMessage
          ...
          details="Please wait, generating LinkedIn authorization link."
        />
      )}
      ...
      {status === 'authorizing' && (
        <DetailedMessage
          ...
          heading="Attestation process:"
          message="Authorizing"
          details="Please wait, accessing LinkedIn account details."
        />
      )}
      ...
      {status === 'authorized' && profile && (
        <form onSubmit={handleSubmit}>
          <dl className={styles.profile}>
            ...
            <dt>First name:</dt>
            <dd>{profile.localizedFirstName}</dd>

            <dt>Last name:</dt>
            <dd>{profile.localizedLastName}</dd>
          </dl>
      ...
      {flowError === 'unauthorized' && (
        <DetailedMessage
          ...
          message="There was an error authorizing your LinkedIn account."
