...
export function InstagramTemplate({
  ...
  return (
    ...
    >
      ...
      <h1 className={styles.heading}>Instagram Account Attestation</h1>

      <Prompt
        when={preventNavigation}
        message="The Instagram attestation process has already started. Are you sure you want to leave?"
      />

      <Explainer>
        After you sign into your Instagram account and give SocialKYC
        permission, SocialKYC requests your Instagram information for the
